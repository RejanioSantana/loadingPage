                        ...
                        <table class="table table-bordered table-stripped">
                            ...
                            <tbody>
                                <?php
                                    echo"<tr>";
                                    echo"<td>";
                                    echo"<img src=\"".$datas['favicon']."\" height=\"50\">";
                                    echo"</td>";
                                    echo"<td>";
                    ...
                    <div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal-content animated bounceInRight">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group"><label>Selecione o arquivo(Max: 2M)</label> <input type="file" name="favicon" accept="image/*" size="2M" class="form-control"></div>
                                </div>
